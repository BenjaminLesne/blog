...
-write section saying to update the current domain of our app in Coolify to the domaine name we bought with HTTPS at the begining.

- sync the VPS ip address with the domain name in the domain provider dashboard
...
seetup the domain name with the VPS purchased
